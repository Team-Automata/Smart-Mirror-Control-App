...
public class BluetoothLeConnection extends BluetoothConnection {
	private static final UUID MESSAGE_UUID = UUID.fromString("00002AF0-0000-1000-8000-00805F9B34FB");
	...
	private void getGattCharacteristics(List<BluetoothGattService> gattServices) {
		...
		for (BluetoothGattService gattService : gattServices) {
			if(gattService.getCharacteristic(MESSAGE_UUID) != null) {
				driveCharacteristic = gattService.getCharacteristic(MESSAGE_UUID);
			}
		}
